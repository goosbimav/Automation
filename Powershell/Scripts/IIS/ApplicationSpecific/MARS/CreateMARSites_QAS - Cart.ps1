...
#---------------------------------------------------------------------
#Site1 Parameters
$SiteName1 = "qas-cart.macmillanhighered.com" 
$AppPoolName1 = $SiteName1
$AppPoolVersion1 = "v4.0" #Entered as (v2.0 or v4.0)
$HostHeader1 = "qas-cart.macmillanhighered.com"
...
#Site1 - "activation.macmillanhighered.com"
	...
	{	
		...
		New-Website -Name $SiteName1 -Port 80 -IPAddress "192.168.225.15" -HostHeader $HostHeader1 -ApplicationPool $SiteName1 -PhysicalPath $PhysicalPath1
	}
#-------	
