...
Write-host "1. Do a Git Pull"
Write-host "2. Do a Git Push"
...
<#
# Show Menu option selection for Git Pull or Push

$title = "Git Options"
$message = "What do you want to do with Git?"

$Git-Pull = New-Object System.Management.Automation.Host.ChoiceDescription "&Git-Pull", `
    "Do a Git Pull."

$Git-Push = New-Object System.Management.Automation.Host.ChoiceDescription "&Git-Push", `
    "Do a Git Push."

$options = [System.Management.Automation.Host.ChoiceDescription[]]($Git-Pull, $Git-Push)

$result = $host.ui.PromptForChoice($title, $message, $options, 0) 

switch ($result)
    {
        0 {Write-Host "You selected Git-Pull."
		...
		1 {Write-Host "You selected Git-Push."
