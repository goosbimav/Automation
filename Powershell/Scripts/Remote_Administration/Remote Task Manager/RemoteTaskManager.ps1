...
$ServerListFile = "D:\E-stuff\Automation\Powershell\Scripts\Remote_Administration\Remote Task Manager\List_Of_Servers\ListOfServers-PXWebServers-PROD.txt"
...
$MyDrive = "C$"
$SourcePath = "D:\E-stuff\Automation\Powershell\Scripts\Delete_Old_Logs"
...
#Function that that adds a Domain User to a Local Security Group
...
Function Create-ScheduledTask($Server) 
	{
		...
		$TaskRun = '"Powershell.exe -ExecutionPolicy Unrestricted c:\Scripts\DeleteOLDlogs.ps1 -Verb RunAs"'
